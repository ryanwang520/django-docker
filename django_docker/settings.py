...
SECRET_KEY = "*+jk5-@as9=s&%8c5dl2b3$g^2ck(ybx!=@qfxw4a)s+_6#8t1"
...
MIDDLEWARE = [
    ...
    "django_docker.middlewares.json_response_middleware",
]
...
#         'USER': config('POSTGRES_USR', 'postgres'),
